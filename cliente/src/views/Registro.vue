<template>
    ...
    <!-- Iconos de datos de paciente -  prescripción - cronograma -->
    ...
    <!-- END Iconos de datos de paciente -  prescripción - cronograma -->

    <!-- Formulario datos de paciente-->
      <form action="zconsultaBoton.html" class="row g-3 " style="margin: 30px 110px 30px 110px;" id="formulario" @submit.prevent="agregarRegistro(registro)">
        ...
        <div class="col-md-3">
          ...
          <select name="tipodocumento" id="tipodocumento" class="form-select" required v-model="registro.tipoDocumento">
        ...
        <div class="col-md-2">
            ...
            <input
              ...
              class="form-control"
              required="true"
              v-model="registro.fechaNacimiento"
            />
          </div>
        ...
        <!-- Campo departamento-->
          <div class="col-md-2">
            ...
            <select name="departamento" id="departamento" class="form-select" required="true" v-model="registro.departamento">
              <option selected="true" disabled="true">Selecciona</option>
        ...
        <div class="col-md-2">
            ...
            <select name="municipio" id="municipio" class="form-select" required="true" v-model="registro.municipio">
              <option selected="true" disabled="true">Selecciona</option>
        ...
        <div class="col-md-4">
          ...
          <select  class="form-select" name="codigoEnfermedades" id="codigoEnfermedades" required v-model="registro.cie">
              <option selected="true" disabled="true">Selecciona</option>
        ...
        <div class="col-md-4">
            ...
            <select
              ...
              class="form-select"
              required="true"
              v-model="registro.estadoActividad"
            >
              <option selected="true" disabled="true">Selecciona</option>
    ...
    <!-- prescripción del medicamento-->
        ...
        <label for="principio" class="form-label" name="principioActivo" id="main_substance"><b>Principio activo</b></label>
          <input
            ...
            v-model="registro.principioActivo"
            />
        </div>
        ...
        <label for="Concentracion" class="form-label" name="concentracion" id="concentration"><b>Concentración</b></label>
          <input
            ...
            class="form-control"
            required="true"
            v-model="registro.concentracion"
            />
        </div>
        ...
        <label for="formaf" class="form-label" name="formaFarmaceutica" id="pharmaceuticalForm"><b>Forma farmacéutica</b></label>
          <input
            ...
            pattern="[a-zA-Z\s\u00C0-\u017F]+"
            title="No se permiten numeros o caracteres especiales"
            v-model="registro.formaFarmaceutica"
            />
        </div>
        ...
        <label for="presentacom" class="form-label" name="presentacion" id="marketPresentation"><b>Presentación comercial</b></label>
          <input
            ...
            class="form-control"
            required="true"
            v-model="registro.presentacionComercial"
            />
        </div>
        ...
        <div class="col-md-2">
            <label for="dosis" class="form-label" name="dosis" id="dose"><b>Dosis del medicamento</b></label>
              <input
                ...
                class="form-control"
                required="true"
                v-model="registro.dosisMedicamento"
                />
            </div>
        ...
        <label for="dosis" class="form-label" name="administracion" id="admin"><b>Vía de administración</b></label>
          <input
            ...
            pattern="[a-zA-Z\s\u00C0-\u017F]+"
            title="No se permiten numeros o caracteres especiales"
            v-model="registro.víaAdministracion"
            />
        </div>
    ...
    <!-- END Formulario datos de paciente-->
...
export default {
  ...
  data(){
    return{
      ...
      registro:{
          ...
          // idDocumentoAcudiente: 0,
          // parentezco: "",
          // idCelularAcudiente: 0,
          medicamento: "",
          principioActivo: "",
          concentracion: "",
          formaFarmaceutica: "",
  ...
  methods: {  
  agregarRegistro(){
      this.axios.post('/nuevo-registro', this.registro)
      .then(res=>{
          this.registros.push(res.data);
          this.registro.nombres="";
          this.registro.apellidos="";
          this.registro.tipoDocumento="";       
          this.registro.idDocumento="";
          this.registro.fechaNacimiento= "";
          this.registro.sexo="";
          this.registro.idCelular="";
          this.registro.departamento="";
          this.registro.municipio="";
          this.registro.barrio="";
          this.registro.direccion="";
          this.registro.peso="";
          this.registro.tipoSangre="";
          this.registro.cie="";
          this.registro.diagnostico="";
          this.registro.estadoActividad="";
          this.registro.medicamento="";
          this.registro.principioActivo="";
          this.registro.concentracion="";
          this.registro.formaFarmaceutica="";
          this.registro.unidadMedida="";
          this.registro.presentacionComercial="";
          this.registro.dosisMedicamento="";
          this.registro.víaAdministracion="";
          this.registro.frecuencia="";
