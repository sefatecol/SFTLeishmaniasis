<template>
    ...
    <!-- Formulario datos de paciente-->
      <form action="zconsultaBoton.html" class="row g-3 " style="margin: 80px auto auto auto;" id="formulario" @submit.prevent="editarRegistro(registroEditar)">
    ...
    <!-- Tabla de listado de pacientes -->
            ...
            <tbody>
                <tr v-for="(item, index) in registros" :key="index">
                    ...
                    <td>
                        <button @click="eliminarRegistro(item._id)" class="btn-danger mx-2">Eliminar</button>
                        <button @click="activarEdicion(item._id)" class="btn-warning mx-2">Editar</button>
                        <button @click="activarVisualizacion(item._id)" class="btn-primary mx-2">visualizar</button>
                    </td>
                </tr>
            </tbody>
        </table>
