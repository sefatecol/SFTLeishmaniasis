<template>
    ...
    <!-- Formulario datos de paciente-->
      <form action="zconsultaBoton.html" class="row g-3 " style="margin: 80px auto auto auto;" id="formulario">
        ...
        <!-- Campo departamento-->
          <div class="col-md-2">
            ...
            <select name="departamento" id="departamento" class="form-select" required="true">
              <option selected="true" disabled="true">Selecciona</option>
        ...
        <div class="col-md-2">
            ...
            <select name="municipio" id="municipio" class="form-select" required="true">
              <option selected="true" disabled="true">Selecciona</option>
        ...
        <div class="col-md-4">
          ...
          <select  class="form-select" name="codigoEnfermedades" id="codigoEnfermedades" required>
              <option selected="true" disabled="true">Selecciona</option>
    ...
    <!-- Formulario cronograma de administración del medicamento-->
    <label class="visually" for="inlineFormInputGroupUsername" style="color: #50D8AF; font-size: larger;">
      <svg class="bi me-2" width="16" height="16"><use href="#alarm"/></svg>
      <b>Cronograma de administración</b></label>
  </form>
    
      <!-- Tabla cronograma de administración del medicamento-->
  <table class="table table-striped table-hover">
    <thead>
      <tr>
        <!-- Fila 1-->
        <th scope="col">Día de tratamiento</th>
        <th scope="col">1</th>
        <th scope="col">2</th>
        <th scope="col">3</th>
        <th scope="col">4</th>
    ...
    <!-- Fila 2-->
      <tr>
        <th scope="row">Fecha de administración</th>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
    ...
    <!-- Fila 3-->
      <tr>
        <th scope="row">Unidades administradas</th>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
    ...
    <!-- Fila 4A -->
      <tr>
        <th scope="row">Lote del medicamento</th>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
    ...
    <!-- Fila 4B-->
    <tr>
      <th scope="row">Laboratorio farmacéutico</th>
      <td></td>
      <td></td>
      <td></td>
      <td></td>
    ...
    <!-- Fila 5-->
      <tr>
        <th scope="row">FV del medicamento</th>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
    ...
    <!-- Fila 6-->
      <tr>
        <th scope="row">Profesional que entrega</th>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
    ...
    <!-- Fila 7-->
      <tr>
        <th scope="row">Profesional que recibe</th>
        <td></td>
        <td></td>
        <td></td>
        <td></td>
...
<!-- END Tabla cronograma de administración del medicamento-->
